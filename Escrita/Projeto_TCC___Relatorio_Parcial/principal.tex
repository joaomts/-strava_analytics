...
\begin{titlepage}
    \bfseries\LARGE
    \centering
    \vspace*{3cm} % Espaço vertical
    {ANÁLISE DE DESEMPENHO DE CORREDORES UTILIZANDO DADOS DO STRAVA: UMA ABORDAGEM DE REGRESSÃO LINEAR.}
    \vspace{2cm} % Espaço vertical
    % {\Large Subtítulo ou qualquer outra informação}\par
    \vfill
    \begin{center}
    \begin{large}
    \begin{tabular}{c}
...
%====================================================================
\newpage
\input{resltados_parciais.tex}

%====================================================================
% DESCRIÇÃO DE ATIVIDADES E AVALIAÇÃO
%====================================================================
\newpage
\input{descricao_atividades_avaliacao.tex}
